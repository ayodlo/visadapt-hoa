...
const MENU: { icon: keyof typeof MaterialIcons.glyphMap; label: string; href: string }[] = [
  ...
  { icon: 'warning', label: 'Violations', href: '/more/violations' },
...
export default function MoreMenu() {
  ...
  return (
    <ScreenContainer>
      ...
      <ListCard>
        <ListRow icon="person" title={`${user?.firstName} ${user?.lastName}`} subtitle="Profile & Settings" onPress={() => router.push('/more/profile')} />
